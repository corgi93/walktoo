...
export const DIARY_THEMES: Record<DiaryThemeId, DiaryTheme> = {
  y2k_pastel: {
    ...
    accent: '#D96F5E',
    accentDeep: '#A94B40',
    tints: ['#F4C9BD', '#F5DFAE', '#CFE2D3', '#D9D9E7', '#D8E6ED'],
  ...
  vintage_film: {
    ...
    accent: '#9C6B4D',
    accentDeep: '#6D452F',
    tints: ['#D9C4AA', '#CBD5D7', '#EFE1C8', '#BCA48C', '#A88968'],
    titleFont: PIXEL_FONT,
    titleWeight: '400',
    bodyFont: PIXEL_FONT,
    bodyWeight: '400',
  ...
  pixel_retro: {
    ...
    accent: '#E06F52',
    accentDeep: '#9F3E2F',
    tints: ['#F2B8A8', '#FFD98A', '#9ED6C6', '#B8D9F2', '#D8C3EC'],
    titleFont: PIXEL_FONT,
    titleWeight: '400',
    bodyFont: PIXEL_FONT,
    bodyWeight: '400',
  ...
  grid_minimal: {
    ...
    accent: '#4F7F76',
    accentDeep: '#2D5952',
    tints: ['#F0EDE6', '#DDEBE5', '#EFD9D0', '#EFECE5', '#D8E4EA'],
    titleFont: PIXEL_FONT,
    titleWeight: '400',
    bodyFont: PIXEL_FONT,
    bodyWeight: '400',
  ...
  dreamy_cloud: {
    ...
    accent: '#6F9BC8',
    accentDeep: '#406F9C',
    tints: ['#CFE3F0', '#D7E8F5', '#E2D5E8', '#EFCAC7', '#F4E8B0'],
    titleFont: PIXEL_FONT,
    titleWeight: '400',
    bodyFont: PIXEL_FONT,
    bodyWeight: '400',
  ...
  dark_academia: {
    ...
    accent: '#9B3A32',
    accentDeep: '#5E1F1B',
    tints: ['#E4D6BD', '#D8C49C', '#C2B089', '#B58B78', '#8A7A5A'],
    titleFont: PIXEL_FONT,
    titleWeight: '400',
    bodyFont: PIXEL_FONT,
    bodyWeight: '400',
